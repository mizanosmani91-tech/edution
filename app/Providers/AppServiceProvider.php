...
class AppServiceProvider extends ServiceProvider
{
     ...
     *
     * প্রথমবার রেজিস্টার হওয়ার পর storage/fonts এ ক্যাশ হয়ে যায় (VPS-এ
    ...
    private function registerPdfFonts(): void
    {
        ...
        // ⚠️ registerFont() শুধুমাত্র এই রিকোয়েস্টের সাময়িক FontMetrics ইনস্ট্যান্সের in-memory এরে সেট করে (setFontFamily), ডিস্কে লেখে না — পরের রিকোয়েস্টে (barryvdh Pdf facade এর আলাদা Dompdf ইনস্ট্যান্স) এই ইন-মেমরি ডেটা হারিয়ে যায় — ফলে এক্সপোর্ট করা PDF-এ কখনও ফন্ট পাওয়া যানি না, বাংলা তাই "?" হয়ে থাকতেসে — এটাই আসল বাগ ছিল।
