...
<div class="app" id="app" x-data="{ collapsed: false, mobileOpen: false }" :class="{ collapsed: collapsed, 'mobile-open': mobileOpen }">
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-scroll">
            ...
            {{-- শিক্ষার্থী --}}
            <div class="nav-module {{ $activeIf('students.*') }}" x-data="{ open: {{ request()->routeIs('students.*') ? 'true' : 'false' }} }" :class="{ open: open }">
                <button class="nav-btn" @click="open = !open" type="button">
                ...
                <div class="sub-wrap"><div class="sub-inner"><div class="sub-list">
                    ...
                    <a href="{{ $stub('আইডি কার্ড') }}" class="sub-item">আইডি কার্ড জেনারেশন</a>
            ...
            <div class="nav-module" x-data="{ open: false }" :class="{ open: open }">
                ...
                <div class="sub-wrap"><div class="sub-inner"><div class="sub-list">
                    <a href="{{ $stub('রুট ও গাড়ি') }}" class="sub-item">রুট ও গাড়ি</a>
                    <a href="{{ $stub('পরিবহন সংযুক্তি') }}" class="sub-item">ছাত্র-পরিবহন সংযুক্তি</a>
                </div></div></div>
            </div>
